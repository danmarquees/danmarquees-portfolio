    ...
    <>
      ...
      <section id="gallery">
        ...
        <div className="gallery-grid" id="galleryGrid">
          {/* Live Static Demo 1: KURA Spatial Design */}
          <GalleryDemo t={t} variant="kura" />

          {galleryItems.slice(0, 5).map(([span, category, src, alt], index) => (
            <div
          ...
          {/* Live Static Demo 2: ATELIER DADA */}
          <GalleryDemo t={t} variant="dada" />

          {galleryItems.slice(5).map(([span, category, src, alt], idx) => {
            const index = idx + 5;
            return (
              <div
                className={`gallery-item ${span}`}
